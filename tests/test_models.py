...
class TestCard:
    ...
    def test_card_creation(self):
        ...
        card = Card(name="Sol Ring", set_name="Commander 2021", quantity=2)
    ...
    def test_legacy_foil_support(self):
        ...
        card = Card(name="Test Card", set_name="Test Set", quantity=1, foil=True)
    ...
    def test_unique_key_generation(self):
        ...
        card1 = Card(
            name="Sol Ring", set_name="Commander 2021", quantity=1, set_code="C21"
        )
        ...
        card3 = Card(
            name="Sol Ring", set_name="Commander 2021", quantity=1, set_code="C22"
        )
    ...
    def test_card_validation(self):
        ...
        with pytest.raises(ValueError):
            Card(name="Test Card", set_name="Test Set", quantity=0)  # Should be >= 1
...
class TestPriceData:
    ...
    def test_price_data_creation(self):
        ...
        price_data = PriceData(vendor="Star City Games", price=15.50, condition="NM")
    ...
    def test_price_validation(self):
        ...
        with pytest.raises(ValueError):
            PriceData(vendor="Test Vendor", price=-5.0)  # Should be >= 0
...
class TestCardPrices:
    ...
    def test_update_best_price(self):
        ...
        card_prices.prices["Vendor A"] = PriceData(
            vendor="Vendor A", price=10.0, condition="NM"
        )
        card_prices.prices["Vendor B"] = PriceData(
            vendor="Vendor B", price=15.0, condition="NM"
        )
        card_prices.prices["Vendor C"] = PriceData(
            vendor="Vendor C", price=8.0, condition="NM"
        )
...
class TestCollectionSummary:
    ...
    def test_collection_summary_creation(self):
        ...
        summary = CollectionSummary(
            total_cards=100, cards_with_prices=80, cards_without_prices=20
        )
    ...
    def test_calculate_totals(self):
        ...
        summary = CollectionSummary(
            total_cards=2, cards_with_prices=2, cards_without_prices=0
        )
        ...
        card_prices1.prices["Vendor A"] = PriceData(
            vendor="Vendor A", price=10.0, condition="NM"
        )
        card_prices1.prices["Vendor B"] = PriceData(
            vendor="Vendor B", price=12.0, condition="NM"
        )

        card_prices2 = CardPrices(card=card2)
        card_prices2.prices["Vendor A"] = PriceData(
            vendor="Vendor A", price=5.0, condition="NM"
        )
        card_prices2.prices["Vendor B"] = PriceData(
            vendor="Vendor B", price=4.0, condition="NM"
        )
