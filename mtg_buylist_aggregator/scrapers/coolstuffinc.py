"""CoolStuffInc buylist scraper for MTG cards."""
...
class CoolStuffIncScraper(BaseScraper):
    """Scrapes CoolStuffInc for buylist prices."""

    def __init__(self):
        super().__init__("CoolStuffInc", "https://www.coolstuffinc.com")
        ...
        self.base_url = "https://www.coolstuffinc.com"

    def search_card(self, card: Card) -> Optional[PriceData]:
        """Search for buylist price of a card on CoolStuffInc."""
        try:
            # Build search query
            ...
            params = {"q": query, "category": "Magic: The Gathering"}
            ...
            logger.error(f"Error searching CoolStuffInc for {card.name}: {e}")
            return None

    def get_buylist(self) -> List[PriceData]:
        """CoolStuffInc buylist not implemented yet, return empty list."""
        return []

    def _build_search_query(self, card: Card) -> str:
        """Build CoolStuffInc search query for a card."""
