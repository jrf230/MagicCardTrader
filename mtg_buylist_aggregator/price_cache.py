            ...
            if cached_data:
                ...
                if current_time - cache_time < timedelta(hours=24):
                        ...
                        serializable_vendor_prices[vendor] = [
                            {
                                ...
                                'last_price_update': pd.last_price_update.isoformat() if pd.last_price_update else None,
                                'notes': pd.notes
                            }
                    ...
                    result.append({
                        ...
                        'best_bid': card_prices.best_bid.dict() if card_prices.best_bid else None,
                        'best_offer': card_prices.best_offer.dict() if card_prices.best_offer else None,
            ...
            for vendor, price_data_list in card_prices.prices.items():
                ...
                for price_data in price_data_list:
                    ...
                    if 'offer' in price_type.lower() or 'sell' in price_type.lower():
                        ...
                        if any(keyword in vendor_lower for keyword in ['tcg', 'ebay', 'marketplace']):
