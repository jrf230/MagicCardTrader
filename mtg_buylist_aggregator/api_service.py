...
class APIService:
    ...
    def get_collection_data(self, force_refresh: bool = False) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            if not cards:
                return {"cards": [], "total_cards": 0, "cache_status": "no_data"}

            # Try to get cached prices first
            card_prices_list = self.db.get_price_cache(
                cards, force_refresh=force_refresh
            )
            ...
            for card_prices in card_prices_list:
                ...
                if card_prices.best_bid:
                    card_data["best_bid"] = {
                        ...
                        "last_price_update": (
                            card_prices.best_bid.last_price_update.isoformat()
                            if card_prices.best_bid.last_price_update
                            else None
                        ),
                ...
                if card_prices.best_offer:
                    card_data["best_offer"] = {
                        ...
                        "last_price_update": (
                            card_prices.best_offer.last_price_update.isoformat()
                            if card_prices.best_offer.last_price_update
                            else None
                        ),
    ...
    def get_dashboard_data(self, force_refresh: bool = False) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            # Generate analytics
            dashboard_data = self._generate_dashboard_analytics(
                card_prices_list, collection_data
            )
    ...
    def get_hot_cards(self, force_refresh: bool = False) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            hot_cards_data = {"hot_cards": hot_cards, "total_hot_cards": len(hot_cards)}
    ...
    def get_recommendations(self, force_refresh: bool = False) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            recommendations = recommendation_engine.generate_recommendations(
                cards, use_mock=False
            )

            # Cache the result
            self.db.set_analytics_cache(
                "recommendations", recommendations, ttl_hours=12
            )
    ...
    def _generate_dashboard_analytics(
        self, card_prices_list: List[CardPrices], collection_data: Dict
    ) -> Dict[str, Any]:
        ...
        diversification = collection_analytics._analyze_diversification(
            card_prices_list
        )
        ...
        top_performers = collection_analytics._identify_top_performers(
            card_prices_list, limit=5
        )
        bottom_performers = collection_analytics._identify_underperformers(
            card_prices_list, limit=5
        )
        ...
        alerts = [
            {
                "type": "reprint_risk",
                "card": "Sol Ring",
                "message": "High reprint risk this year.",
            },
            {
                "type": "price_spike",
                "card": "Tarmogoyf",
