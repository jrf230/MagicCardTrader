...
def test_cardkingdom():
    ...
    for card in test_cards:
        ...
        if result and result.price:
            ...
            if result.all_conditions:
                print(f"   Found prices: {result.all_conditions.get('found_prices', 'N/A')}")
    ...
    print(f"   Average price: ${total_value/found_prices:.2f}" if found_prices > 0 else "   Average price: N/A")
