        ...
        try:
            ...
            if buylist_data:
                ...
                if buylist_data.all_conditions.get(
                    "cash_price"
                ) and buylist_data.all_conditions.get("credit_price"):
                    print(f"  Cash: ${buylist_data.all_conditions['cash_price']}")
                    print(f"  Credit: ${buylist_data.all_conditions['credit_price']}")
                    print(
                        f"  Trade-in Bonus: {buylist_data.all_conditions['trade_in_bonus']*100}%"
                    )
                    print(
                        f"  TCG Low Reference: ${buylist_data.all_conditions['tcg_low_reference']}"
                    )
